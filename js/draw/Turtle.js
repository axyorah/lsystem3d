class Turtle {
    ...
    moveTo(position) {
        ...
        if (!(position instanceof THREE.Vector3)) {
            throw new TypeError(
                `Argument for 'Turtle.moveTo' should be of type 'THREE.Vector3' but got ${position}`
            );
        }
    ...
    orient(quaternion) {
        ...
        if (!(quaternion instanceof THREE.Quaternion)) {
            throw TypeError(
                `Argument for 'Turtle.orion' should be of type 'THREE.Quaternion' but got ${quaternion}`
            );
        }
